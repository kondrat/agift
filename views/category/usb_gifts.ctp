...
<?php 
		...
		foreach ($gifts as $gift) {
            ...
            echo '		<td width="230" align ="center"><br><br>';
          		echo $html->link( $html->image('usb/s/'.$gift['Image'][0]['img'], array('border' => 0) ), array( 'controller' => 'gifts', 'action' => 'view',$gift['Gift']['id'])  , array(), false, false );
            echo '</td></tr><tr>';
