...
<tr>
	...
	<td width="265">
		<?php echo $form->text('username', array('class' => '', 'size' => 36 ) ); ?>
...
<tr>
	...
	<td width="265">
        <?php echo $form->password('password1' , array('class' => '', 'size' => 36) ); ?>
...
<tr>
	...
	<td width="265">
		<?php echo $form->password('password2', array('class' => '', 'size' => 36 ) ); ?>
...
<tr>
	...
	<td width="265">
		<?php echo $form->text('contact', array('class' => '', 'size' => 36 ) ); ?>
...
<tr>
	...
	<td width="265">
		<?php echo $form->text('phone', array('class' => '', 'size' => 36 ) ); ?>
...
<tr>
	...
	<td width="265">
		<?php echo $form->text('email', array('class' => '', 'size' => 36 ) ); ?>
...
<tr>
	...
	<td width="265">
		<?php echo $form->text('company', array('class' => '', 'size' => 36 ) ); ?>
...
<tr>
	...
	<td width="265">
		<?php echo $form->text('business', array('class' => '', 'size' => 36 ) ); ?>
	</td>
</tr>
<tr>
	<td height="40" width="120"><b>Факс:</b></td>
	<td width="265">
		<?php echo $form->text('fax', array('class' => '', 'size' => 36 ) ); ?>
...
<tr>
	...
	<td width="265">
		<?php echo $form->text('website', array('class' => '', 'size' => 36 ) ); ?>
...
<tr>
	...
	<td width="265">
		<?php echo $form->text('address1', array('class' => '', 'size' => 36 ) ); ?>
	</td>
</tr>
<tr>
	<td height="40" width="120"><b>Фактический адрес:</b></td>
	<td width="265">
		<?php echo $form->text('address2', array('class' => '', 'size' => 36 ) ); ?>
	</td>
</tr>
<tr>
	<td height="140" width="120"><b>Банковские реквизиты:</b></td>
	<td width="265">
		<?php echo $form->input('bank_detail', array( 'type' => 'textarea', 'class' => '', 'rows' => 6, 'cols' => 27, 'label' => false ) ); ?>
	</td>
</tr>
</table>
</fieldset>
